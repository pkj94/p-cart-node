module.exports = class ColumnLeft extends global['\Opencart\System\Engine\Controller'] {
	/**
	 * @return string
	 */
	async index() {
		...
		const modules = await this.model_design_layout.getModules(layout_id, 'column_left');

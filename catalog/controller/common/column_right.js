module.exports = class ControllerCommonColumnRight extends Controller {
	async index() {
		const data = {};
		...
		const modules = await this.model_design_layout.getLayoutModules(layout_id, 'column_right');

module.exports = class ColumnRight extends global['OpencartSystemEngineController'] {
	/**
	 * @return string
	 */
	async index() {
		...
		const modules = await this.model_design_layout.getModules(layout_id, 'column_right');
		...
		return await this.load.view('common/column_right', data);
	}
}
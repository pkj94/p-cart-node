...
class OrderController extends Controller {
	 ...
	 * @throws \Exception
	 */
	async add(array order_info, int order_status_id, string comment, bool notify): void {
	 ...
	 * @throws \Exception
	 */
	async edit(array order_info, int order_status_id, string comment, bool notify): void {
		store_name = html_entity_decode(this->config->get('config_name'));
	 ...
	 * @throws \Exception
	 */
	async alert(string &route, array &args): void {
		if ((args[0])) {
			order_id = args[0];
		} else {
			order_id = 0;

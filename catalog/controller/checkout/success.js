...
const data = {};
		...
		if (await this.customer.isLogged()) {
			data['text_message'] = sprintf(this.language.get('text_customer'), await this.url.link('account/account', '', true), await this.url.link('account/order', '', true), await this.url.link('account/download', '', true), await this.url.link('information/contact'));
		} else {
			data['text_message'] = sprintf(this.language.get('text_guest'), await this.url.link('information/contact'));
		}

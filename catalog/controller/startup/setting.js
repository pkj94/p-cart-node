module.exports = class Setting extends global['OpencartSystemEngineController'] {
	...
	async index() {
		...
		// Url
		this.registry.set('url', new global['OpencartSystemLibraryUrl'](this.config.get('config_url')));

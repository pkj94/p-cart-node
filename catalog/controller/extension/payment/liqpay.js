...
const data = {};
		...
		xml += '	<result_url>' + await this.url.link('checkout/success', '', true) + '</result_url>';
		xml += '	<server_url>' + await this.url.link('extension/payment/liqpay/callback', '', true) + '</server_url>';
		...
		return await this.load.view('extension/payment/liqpay', data);
	}

module.exports = {
    // Heading
    heading_title: 'Find Your Favorite Brand',

    // Text
    text_brand: 'Brand',
    text_index: 'Brand Index:',
    text_error: 'Brand not found!',
    text_empty: 'There are no products to list.',
    text_no_results: 'There are no brands to list.',
    text_quantity: 'Qty:',
    ...
    text_price_asc: 'Price (Low &gt, High)',
    text_price_desc: 'Price (High &gt, Low)',

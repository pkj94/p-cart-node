...
class ArticleController extends Model {
	 ...
	 * @return array
	 */
	async getArticle(article_id): array {
	 ...
	 * @return array
	 */
	async getArticles(array data = []): array {
	 ...
	 * @return array
	 */
	async getLayoutId(article_id): int {
	 ...
	 * @return int
	 */
	async addComment(article_id, array data): int {
	 ...
	 * @return array
	 */
	async getComments(article_id, int start = 0, int limit = 10): array {
		if (start < 0) {
			start = 0;
		}
	 ...
	 * @return int
	 */
	async getTotalComments(article_id): int {

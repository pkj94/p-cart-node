...
class CouponController extends Model {
	 ...
	 * @return array
	 */
	async getCoupon(string code): array {
		status = true;
	 ...
	 * @return int
	 */
	async getTotalHistoriesByCoupon(string coupon): int {
	 ...
	 * @return int
	 */
	async getTotalHistoriesByCustomerId(string coupon, int customer_id): int {

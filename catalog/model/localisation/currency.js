 ...
 */
class CurrencyController extends Model {
	/**
	 * @param string code
	 * @param float  value
	 *
	 * @return void
	 */
	async editValueByCode(string code, float value): void {
	 ...
	 * @return array
	 */
	async getCurrency(currency_id): array {
	 ...
	 * @return array
	 */
	async getCurrencyByCode(string currency): array {

...
class ProductController extends Model {
	 ...
	 */
	async __construct(\Opencart\System\Engine\Registry registry) {
	 ...
	 * @return array
	 */
	async getProduct(product_id): array {
	 ...
	 * @return array
	 */
	async getProducts(array data = []): array {
	 ...
	 * @return array
	 */
	async getCategories(product_id): array {
	 ...
	 * @return array
	 */
	async getAttributes(product_id): array {
	 ...
	 * @return array
	 */
	async getOptions(product_id): array {
		product_option_data = [];
	 ...
	 * @return array
	 */
	async getDiscounts(product_id): array {
	 ...
	 * @return array
	 */
	async getImages(product_id): array {
	 ...
	 * @return array
	 */
	async getSubscription(product_id, int subscription_plan_id): array {
	 ...
	 * @return array
	 */
	async getSubscriptions(product_id): array {
	 ...
	 * @return int
	 */
	async getLayoutId(product_id): int {
	 ...
	 * @return array
	 */
	async getRelated(product_id): array {
	 ...
	 * @return int
	 */
	async getTotalProducts(array data = []): int {
	 ...
	 * @return array
	 */
	async getSpecials(array data = []): array {
	 ...
	 * @return void
	 */
	async addReport(product_id, string ip, string country = ''): void {

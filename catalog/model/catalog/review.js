...
class ReviewController extends Model {
	 ...
	 * @return int
	 */
	async addReview(product_id, array data): int {
	 ...
	 * @return array
	 */
	async getReviewsByProductId(product_id, int start = 0, int limit = 20): array {
		if (start < 0) {
			start = 0;
		}
	 ...
	 * @return int
	 */
	async getTotalReviewsByProductId(product_id): int {

...
class Affiliate extends \Opencart\System\Engine\Model {
	 ...
	 * @return void
	 */
	public function addAffiliate($customer_id, array $data): void {
	 ...
	 * @return void
	 */
	public function editAffiliate($customer_id, array $data): void {
	 ...
	 * @return void
	 */
	public function addReport($customer_id, string $ip, string $country = ''): void {

...
class DownloadController extends Model {
	 ...
	 * @return array
	 */
	async getDownload($download_id): array {
		$implode = [];
	 ...
	 * @return array
	 */
	async getDownloads($start = 0, int $limit = 20): array {
		if ($start < 0) {
			$start = 0;
		}
	 ...
	 * @return void
	 */
	async addReport($download_id, string $ip, string $country = ''): void {

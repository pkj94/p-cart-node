...
class Address extends \Opencart\System\Engine\Model {
	 ...
	 * @return int
	 */
	public function addAddress($customer_id, array $data): int {
	 ...
	 * @return void
	 */
	public function editAddress($address_id, array $data): void {
	 ...
	 * @return void
	 */
	public function deleteAddress($address_id): void {
	 ...
	 * @return array
	 */
	public function getAddress($customer_id, int $address_id): array {
	 ...
	 * @return array
	 */
	public function getAddresses($customer_id): array {
		$address_data = [];
	 ...
	 * @return int
	 */
	public function getTotalAddresses($customer_id): int {

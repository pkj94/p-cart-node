...
class PaymentMethodController extends Model {
	 ...
	 * @return void
	 */
	async addPaymentMethod(array data): void {
	 ...
	 * @return void
	 */
	async deletePaymentMethod(customer_payment_id): void {
	 ...
	 * @return array
	 */
	async getPaymentMethod(customer_id, int customer_payment_id): array {
	 ...
	 * @return array
	 */
	async getPaymentMethods(customer_id): array {
	 ...
	 * @return int
	 */
	async getTotalPaymentMethods(): int {

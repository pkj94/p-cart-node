...
class ReturnsController extends Model {
	 ...
	 * @return int
	 */
	async addReturn(array data): int {
	 ...
	 * @return array
	 */
	async getReturn(return_id): array {
	 ...
	 * @return array
	 */
	async getReturns(start = 0, int limit = 20): array {
		if (start < 0) {
			start = 0;
		}
	 ...
	 * @return array
	 */
	async getHistories(return_id): array {

...
class SubscriptionController extends Model {
	 ...
	 * @return int
	 */
	async addSubscription(array data): int {
	 ...
	 * @return void
	 */
	async editSubscription(subscription_id, array data): void {
		if (data['trial_status'] && data['trial_duration']) {
			trial_remaining = data['trial_duration'] - 1;
			remaining = data['duration'];
		} elseif (data['duration']) {
	 ...
	 * @return void
	 */
	async deleteSubscriptionByOrderId(order_id): void {
	 ...
	 * @return void
	 */
	async addHistory(subscription_id, int subscription_status_id, string comment = '', bool notify = false): void {
	 ...
	 * @return void
	 */
	async editSubscriptionStatus(subscription_id, bool subscription_status_id): void {
		this->db->query("UPDATE `" . DB_PREFIX . "subscription` SET `subscription_status_id` = '" . (int)subscription_status_id . "' WHERE `subscription_id` = '" . (int)subscription_id . "'");
	}
	 ...
	 * @return void
	 */
	async editTrialRemaining(subscription_id, int trial_remaining): void {
	 ...
	 * @return void
	 */
	async editDateNext(subscription_id, string date_next): void {

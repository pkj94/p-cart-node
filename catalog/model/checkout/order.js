...
class OrderController extends Model {
	...
	async addOrder(array data): int {
		...
		if ((data['totals'])) {
			foreach (data['totals'] as total) {
				this->db->query("INSERT INTO `" . DB_PREFIX . "order_total` SET `order_id` = '" . (int)order_id . "', `extension` = '" . this->db->escape(total['extension']) . "', `code` = '" . this->db->escape(total['code']) . "', `title` = '" . this->db->escape(total['title']) . "', `value` = '" . total['value'] . "', `sort_order` = '" . (int)total['sort_order'] . "'");
			}
		}
	 ...
	 * @return void
	 */
	async editOrder(order_id, array data): void {
	 ...
	 * @return void
	 */
	async editTransactionId(order_id, string transaction_id): void {
	 ...
	 * @return void
	 */
	async editComment(order_id, string comment): void {
	 ...
	 * @return void
	 */
	async deleteOrder(order_id): void {
	 ...
	 * @return array
	 */
	async getProduct(order_id, int order_product_id): array {
	 ...
	 * @return array
	 */
	async getProducts(order_id): array {
	 ...
	 * @return array
	 */
	async getOptions(order_id, int order_product_id): array {
	 ...
	 * @return array
	 */
	async getSubscription(order_id, int order_product_id): array {
	 ...
	 * @return array
	 */
	async getSubscriptions(array data): array {
	 ...
	 * @return array
	 */
	async getVouchers(order_id): array {
	 ...
	 * @return array
	 */
	async getTotals(order_id): array {
	 ...
	 * @return void
	 */
	async addHistory(order_id, int order_status_id, string comment = '', bool notify = false, bool override = false): void {
		order_info = this->getOrder(order_id);

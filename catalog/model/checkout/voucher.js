...
class VoucherController extends Model {
	 ...
	 * @return int
	 */
	async addVoucher(order_id, array data): int {
	 ...
	 * @return void
	 */
	async disableVoucher(order_id): void {
	 ...
	 * @return array
	 */
	async getVoucher(string code): array {
		status = true;
	 ...
	 * @return void
	 */
	async deleteVoucherByOrderId(order_id): void {

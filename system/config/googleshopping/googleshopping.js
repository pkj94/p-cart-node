module.exports = {
    ...
    advertise_google_push_limit: 1000,// No more than 1000
    advertise_google_report_limit: 1000,// No more than 1000
    advertise_google_product_status_limit: 1000,// No more than 1000

    // An empty [] means it is always required.
    // An [] with values means it is required only in these specific cases
    advertise_google_country_required_fields: {
    ...
    advertise_google_tax_usa_states: {
        '21132': 'Alaska',
        '21133': 'Alabama',
        '21135': 'Arkansas',
        '21136': 'Arizona',
    ...
    advertise_google_google_product_categories: {
    ...
    advertise_google_size_systems: ['AU', 'BR', 'CN', 'DE', 'EU', 'FR', 'IT', 'JP', 'MEX', 'UK', 'US'],

    advertise_google_reporting_intervals: [
        'TODAY',
        'YESTERDAY',
        'LAST_7_DAYS',
        'LAST_WEEK',

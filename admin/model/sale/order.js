module.exports = class OrderSaleModel extends global['OpencartSystemEngineModel'] {
	/**
	 * @param order_id
	 *
	 * @return array
...
if (language_info) {
			...
			return {
				...
				'custom_field': JSON.parse(order_query.row['custom_field'], true),
				...
				'payment_custom_field': JSON.parse(order_query.row['payment_custom_field'], true),
				'payment_method': JSON.parse(order_query.row['payment_method'], true),
				...
				'shipping_custom_field': JSON.parse(order_query.row['shipping_custom_field'], true),
				'shipping_method': JSON.parse(order_query.row['shipping_method'], true),

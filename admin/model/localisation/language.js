module.exports = class ModelLocalisationLanguage extends Model {
	async addLanguage(data) {
		...
		// Attribute
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "attribute_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Attribute Group
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "attribute_group_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Banner
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "banner_image WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Category
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "category_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Customer Group
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "customer_group_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Custom Field
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "custom_field_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Custom Field Value
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "custom_field_value_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Download
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "download_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Filter
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "filter_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Filter Group
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "filter_group_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Information
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "information_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Length
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "length_class_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Option
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "option_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Option Value
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "option_value_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Order Status
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "order_status WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Product
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "product_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Product Attribute
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "product_attribute WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Return Action
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "return_action WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Return Reason
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "return_reason WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Return Status
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "return_status WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Stock Status
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "stock_status WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Voucher Theme
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "voucher_theme_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Weight Class
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "weight_class_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
		...
		// Profiles
		const query = await this.db.query("SELECT * FROM " + DB_PREFIX + "recurring_description WHERE language_id = '" + this.config.get('config_language_id') + "'");
	...
	async editLanguage(language_id, data) {
		language_query = await this.db.query("SELECT `code` FROM " + DB_PREFIX + "language WHERE language_id = '" + language_id + "'");

...
module.exports = class LanguageLocalisationModel extends global['OpencartSystemEngineModel'] {
    ...
    async addLanguage(data) {
        ...
        // Subscription
        query = await this.db.query("SELECT * FROM `" + DB_PREFIX + "subscription_status` WHERE `language_id` = '" + this.config.get('config_language_id') + "'");

        for (let subscription of query.rows) {
            await this.db.query("INSERT INTO `" + DB_PREFIX + "subscription_status` SET `subscription_status_id` = '" + subscription['subscription_status_id'] + "', `language_id` = '" + language_id + "', `name` = " + this.db.escape(subscription['name']) + "");
        }

        // SEO URL
        query = await this.db.query("SELECT * FROM `" + DB_PREFIX + "seo_url` WHERE `language_id` = '" + this.config.get('config_language_id') + "'");

        for (let seo_url of query.rows) {
            await this.db.query("INSERT INTO `" + DB_PREFIX + "seo_url` SET `store_id` = '" + seo_url['store_id'] + "', `language_id` = '" + language_id + "', `key` = " + this.db.escape(seo_url['key']) + ", `value` = " + this.db.escape(seo_url['value']) + ", `keyword` = " + this.db.escape(seo_url['keyword']) + ", `sort_order` = '" + seo_url['sort_order'] + "'");
        }
    ...
    async deleteLanguage(language_id) {
        ...
        await this.db.query("DELETE FROM `" + DB_PREFIX + "attribute_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "attribute_group_description` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('attribute');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "banner_image` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('banner');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "category_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "customer_group_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "custom_field_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "custom_field_value_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "download_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "filter_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "filter_group_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "information_description` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('information');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "length_class_description` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('length_class');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "option_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "option_value_description` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "order_status` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('order_status');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "product_description` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('product');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "product_attribute` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "return_action` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "return_reason` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "return_status` WHERE `language_id` = '" + language_id + "'");
        await this.db.query("DELETE FROM `" + DB_PREFIX + "stock_status` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('stock_status');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "voucher_theme_description` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('voucher_theme');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "weight_class_description` WHERE `language_id` = '" + language_id + "'");

        await this.cache.delete('weight_class');

        await this.db.query("DELETE FROM `" + DB_PREFIX + "subscription_status` WHERE `language_id` = '" + language_id + "'");
    ...
    async getLanguage(language_id) {
        let query = await this.db.query("SELECT DISTINCT * FROM `" + DB_PREFIX + "language` WHERE `language_id` = '" + language_id + "'");
    ...
    async getLanguageByCode(code) {
        let query = await this.db.query("SELECT * FROM `" + DB_PREFIX + "language` WHERE `code` = " + this.db.escape(code));
    ...
    async getTotalLanguages() {
        let query = await this.db.query("SELECT COUNT(*) AS `total` FROM `" + DB_PREFIX + "language`");

module.exports = class ControllerExtensionReportCustomerReward extends Controller {
	...
	async report() {
		...
		customer_total = await this.model_extension_report_customer.getTotalRewardPoints(filter_data);

		results = await this.model_extension_report_customer.getRewardPoints(filter_data);

module.exports = class ControllerExtensionReportMarketing extends Controller {
	...
	async report() {
		...
		marketing_total = await this.model_extension_report_marketing.getTotalMarketing(filter_data);

		results = await this.model_extension_report_marketing.getMarketing(filter_data);

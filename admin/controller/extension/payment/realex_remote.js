module.exports = class ControllerExtensionPaymentRealexRemote extends Controller {
	...
	async order() {
		if (this.config.get('payment_realex_remote_status')) {
			...
			realex_order = await this.model_extension_payment_realex_remote.getOrder(this.request.get['order_id']);
	...
	async void() {
		...
		if ((this.request.post['order_id']) && this.request.post['order_id'] != '') {
			...
			realex_order = await this.model_extension_payment_realex_remote.getOrder(this.request.post['order_id']);

			void_response = await this.model_extension_payment_realex_remote.void(this.request.post['order_id']);
	...
	async capture() {
		...
		if ((this.request.post['order_id']) && this.request.post['order_id'] != '' && (this.request.post['amount']) && this.request.post['amount'] > 0) {
			...
			capture_response = await this.model_extension_payment_realex_remote.capture(this.request.post['order_id'], this.request.post['amount']);
			...
			if ((capture_response.result) && capture_response.result == '00') {
				...
				total_captured = await this.model_extension_payment_realex_remote.getTotalCaptured(realex_order['realex_remote_order_id']);
	...
	async rebate() {
		...
		if ((this.request.post['order_id']) && this.request.post['order_id'] != '') {
			...
			rebate_response = await this.model_extension_payment_realex_remote.rebate(this.request.post['order_id'], this.request.post['amount']);
			...
			if ((rebate_response.result) && rebate_response.result == '00') {
				...
				total_rebated = await this.model_extension_payment_realex_remote.getTotalRebated(realex_order['realex_remote_order_id']);
				total_captured = await this.model_extension_payment_realex_remote.getTotalCaptured(realex_order['realex_remote_order_id']);

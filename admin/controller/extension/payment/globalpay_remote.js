module.exports = class ControllerExtensionPaymentGlobalpayRemote extends Controller {
	...
	async index() {
		...
		if ((this.request.post['payment_globalpay_remote_rebate_password'])) {
		...
		if ((this.request.post['payment_globalpay_remote_geo_zone_id'])) {
		...
		if ((this.request.post['payment_globalpay_remote_total'])) {
		...
		if ((this.request.post['payment_globalpay_remote_sort_order'])) {
		...
		if ((this.request.post['payment_globalpay_remote_status'])) {
		...
		if ((this.request.post['payment_globalpay_remote_card_data_status'])) {
		...
		if ((this.request.post['payment_globalpay_remote_debug'])) {
		...
		if ((this.request.post['payment_globalpay_remote_account'])) {
		...
		if ((this.request.post['payment_globalpay_remote_auto_settle'])) {
		...
		if ((this.request.post['payment_globalpay_remote_tss_check'])) {
		...
		if ((this.request.post['payment_globalpay_remote_3d'])) {
		...
		if ((this.request.post['payment_globalpay_remote_liability'])) {
		...
		if ((this.request.post['payment_globalpay_remote_order_status_success_settled_id'])) {
		...
		if ((this.request.post['payment_globalpay_remote_order_status_success_unsettled_id'])) {
		...
		if ((this.request.post['payment_globalpay_remote_order_status_decline_id'])) {
		...
		if ((this.request.post['payment_globalpay_remote_order_status_decline_pending_id'])) {
		...
		if ((this.request.post['payment_globalpay_remote_order_status_decline_stolen_id'])) {
		...
		if ((this.request.post['payment_globalpay_remote_order_status_decline_bank_id'])) {
		...
		this.response.setOutput(await this.load.view('extension/payment/globalpay_remote', data));
	}
	...
	async void() {
		...
		if ((this.request.post['order_id']) && this.request.post['order_id'] != '') {
			...
			if ((void_response.result) && void_response.result == '00') {
				...
				await this.model_extension_payment_globalpay_remote.updateVoidStatus(globalpay_order['globalpay_remote_order_id'], 1);
	...
	async capture() {
		...
		if ((this.request.post['order_id']) && this.request.post['order_id'] != '' && (this.request.post['amount']) && this.request.post['amount'] > 0) {
			...
			if ((capture_response.result) && capture_response.result == '00') {
				...
				await this.model_extension_payment_globalpay_remote.updateForRebate(globalpay_order['globalpay_remote_order_id'], capture_response.pasref, capture_response.orderid);
	...
	async validate() {
		if (!await this.user.hasPermission('modify', 'extension/payment/globalpay_remote')) {

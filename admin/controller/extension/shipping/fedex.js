module.exports = class ControllerExtensionShippingFedex extends Controller {
	error = {};
	...
	async index() {
		...
		if ((this.request.post['shipping_fedex_test'])) {
		...
		if ((this.request.post['shipping_fedex_service'])) {
			data['shipping_fedex_service'] = this.request.post['shipping_fedex_service'];
		} else if (this.config.has('shipping_fedex_service')) {
		...
		if ((this.request.post['shipping_fedex_width'])) {
		...
		if ((this.request.post['shipping_fedex_height'])) {
		...
		if ((this.request.post['shipping_fedex_length_class_id'])) {
		...
		if ((this.request.post['shipping_fedex_dropoff_type'])) {
		...
		if ((this.request.post['shipping_fedex_packaging_type'])) {
		...
		if ((this.request.post['shipping_fedex_rate_type'])) {
		...
		if ((this.request.post['shipping_fedex_destination_type'])) {
		...
		if ((this.request.post['shipping_fedex_display_time'])) {
		...
		if ((this.request.post['shipping_fedex_display_weight'])) {
		...
		if ((this.request.post['shipping_fedex_weight_class_id'])) {
		...
		if ((this.request.post['shipping_fedex_tax_class_id'])) {
		...
		if ((this.request.post['shipping_fedex_geo_zone_id'])) {
		...
		if ((this.request.post['shipping_fedex_status'])) {
		...
		if ((this.request.post['shipping_fedex_sort_order'])) {
		...
		this.response.setOutput(await this.load.view('extension/shipping/fedex', data));
	}

	async validate() {
		if (!await this.user.hasPermission('modify', 'extension/shipping/fedex')) {

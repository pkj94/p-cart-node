...
class LanguageController extends Controller {
	...
	async getList() {
		...
		const results = await this.model_setting_extension.getPaths('%/admin/controller/language/%.php');
		...
		extensions await this.model_setting_extension.getExtensionsByType('language');

...
module.exports = class LanguageController extends Controller {
	...
	async install() {
		...
		if (!Object.keys(json).length) {
			...
			await this.model_user_user_group.addPermission(this.user.getGroupId(), 'access', 'extension/' + extension + '/language/' + code);
			await this.model_user_user_group.addPermission(this.user.getGroupId(), 'modify', 'extension/' + extension + '/language/' + code);

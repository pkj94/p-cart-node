...
class TotalController extends Controller {
	...
	async getList() {
		...
		const results = await this.model_setting_extension.getPaths('%/admin/controller/total/%.php');
	...
	async install() {
		...
		if (!Object.keys(json).length) {
			...
			await this.model_user_user_group.addPermission(this.user.getGroupId(), 'access', 'extension/' + extension + '/total/' + code);
			await this.model_user_user_group.addPermission(this.user.getGroupId(), 'modify', 'extension/' + extension + '/total/' + code);

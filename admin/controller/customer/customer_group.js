...
class CustomerGroupController extends Controller {
	...
	async getList() {
		...
		data['results'] = sprintf(this.language.get('text_pagination'), (customer_group_total) ? ((page - 1) * this.config.get('config_pagination_admin')) + 1 : 0, (((page - 1) * this.config.get('config_pagination_admin')) > (customer_group_total - this.config.get('config_pagination_admin'))) ? customer_group_total : (((page - 1) * this.config.get('config_pagination_admin')) + this.config.get('config_pagination_admin')), customer_group_total, Math.ceil(customer_group_total / this.config.get('config_pagination_admin')));
	...
	async delete() {
		...
		for (selected of customer_group_id) {

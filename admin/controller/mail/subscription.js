                        ...
                        if (customer_payment_info) {
                            ...
                            if (customer_info) {
                                ...
                                if (language_info) {
                                    ...
                                    await this.load.language('mail/subscription', 'mail', language_code);
                                    ...
                                    if (this.config.get('config_mail_engine')) {
                                        ...
                                        mail.setSubject(html_entity_decode(sprintf(this.language.get('mail_text_subject'), store_name)));
                                        mail.setText(await this.load.view('mail/subscription_history', data));
                                        mail.send();
                                    }
                                }
                            }
                        ...
                        if (order_info['payment_method'] == subscription['payment_method'] && subscription['payment_method'] == payment_method) {
                            ...
                            if (order_info['payment_code'] == subscription['payment_code'] && subscription['payment_code'] == payment_code) {
                                ...
                                if (this.config.get('config_mail_engine')) {
                                    ...
                                    mail.setFrom(from);
                                    mail.setSender(html_entity_decode(store_name));
                                    mail.setSubject(html_entity_decode(sprintf(this.language.get('text_subject'), store_name)));
                                    mail.setText(await this.load.view('mail/subscription_canceled', data));
                                    mail.send();
                                }
                            }
                        }

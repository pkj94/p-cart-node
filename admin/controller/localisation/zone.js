...
module.exports = class ZoneController extends global['\Opencart\System\Engine\Controller'] {
	/**
	 * @return void
	 */
	async index() {
	...
	async getList() {
		...
		const zone_total = await this.model_localisation_zone.getTotalZones(filter_data);
	...
	async save() {
		...
		if (!Object.keys(json.error).length) {
			this.load.model('localisation/zone', this);
			this.request.post['zone_id'] = Number(this.request.post['zone_id']);

...
class ReturnReasonController extends Controller {
	...
	async getList() {
		...
		data['results'] = sprintf(this.language.get('text_pagination'), (return_reason_total) ? ((page - 1) * this.config.get('config_pagination_admin')) + 1 : 0, (((page - 1) * this.config.get('config_pagination_admin')) > (return_reason_total - this.config.get('config_pagination_admin'))) ? return_reason_total : (((page - 1) * this.config.get('config_pagination_admin')) + this.config.get('config_pagination_admin')), return_reason_total, Math.ceil(return_reason_total / this.config.get('config_pagination_admin')));

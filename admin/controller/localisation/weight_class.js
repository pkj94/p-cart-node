...
module.exports = class WeightController extends global['\Opencart\System\Engine\Controller'] {
	/**
	 * @return void
	 */
	async index() {
	...
	async getList() {
		...
		const weight_class_total = await this.model_localisation_weight_class.getTotalWeightClasses();
	...
	async save() {
		...
		if (!Object.keys(json.error).length) {
			this.load.model('localisation/weight_class', this);
			this.request.post['weight_class_id'] = Number(this.request.post['weight_class_id']);
	...
	async delete() {
		...
		for (let weight_class_id of selected) {

...
module.exports = class CountryController extends global['\Opencart\System\Engine\Controller'] {
	/**
	 * @return void
	 */
	async index() {
	...
	async getList() {
		...
		const country_total = await this.model_localisation_country.getTotalCountries(filter_data);
	...
	async save() {
		...
		if (!Object.keys(json.error).length) {
			this.load.model('localisation/country', this);
			this.request.post['country_id'] = Number(this.request.post['country_id']);
	...
	async delete() {
		...
		for (let country_id of selected) {

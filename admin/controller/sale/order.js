...
module.exports = class OrderController extends global['OpencartSystemEngineController'] {
	/**
	 * @return void
	 */
	async index() {
	...
	async info() {
		...
		if ((this.session.data['api_session'])) {
			let session = new global['OpencartSystemLibrarySession'](this.request.server.session);

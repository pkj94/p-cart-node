...
global['\Opencart\Admin\Controller\Extension\Opencart\Report\ProductPurchased'] = class ProductPurchased extends global['\Opencart\System\Engine\Controller'] {
	...
	async index() {
		...
		data['breadcrumbs'].push({
			...
			'href': await this.url.link('extension/opencart/report/product_purchased', 'user_token=' + this.session.data['user_token'])
		});

		data['save'] = await this.url.link('extension/opencart/report/product_purchased.save', 'user_token=' + this.session.data['user_token']);
	...
	async getReport() {
		...
		data['pagination'] = await this.load.controller('common/pagination', {
			...
			'page': page,
			'limit': this.config.get('config_pagination'),
			'url': await this.url.link('extension/opencart/report/product_purchased.report', 'user_token=' + this.session.data['user_token'] + '&code=product_purchased' + url + '&page={page}')
		});

...
global['\Opencart\Admin\Controller\Extension\Opencart\Report\CustomerTransaction'] = class CustomerTransaction extends global['\Opencart\System\Engine\Controller'] {
	...
	async index() {
		...
		data['breadcrumbs'].push({
			...
			'href': await this.url.link('extension/opencart/report/customer_transaction', 'user_token=' + this.session.data['user_token'])
		});

		data['save'] = await this.url.link('extension/opencart/report/customer_transaction+save', 'user_token=' + this.session.data['user_token']);
	...
	async getReport() {
		...
		data['pagination'] = await this.load.controller('common/pagination', {
			...
			'page': page,
			'limit': this.config.get('config_pagination'),
			'url': await this.url.link('extension/opencart/report/customer_transaction+report', 'user_token=' + this.session.data['user_token'] + '&code=customer_transaction' + url + '&page={page}')
		});

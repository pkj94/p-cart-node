global['\Opencart\Admin\Controller\Extension\Opencart\Module\Store'] = class Store extends global['\Opencart\System\Engine\Controller'] {
	...
	async index() {
		...
		data.breadcrumbs.push({
			...
			href: await this.url.link('extension/opencart/module/store', 'user_token=' + this.session.data.user_token)
		});

		data.save = await this.url.link('extension/opencart/module/store.save', 'user_token=' + this.session.data.user_token);

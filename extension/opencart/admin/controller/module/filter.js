global['\Opencart\Admin\Controller\Extension\Opencart\Module\Filter'] = class Filter extends global['\Opencart\System\Engine\Controller'] {
	...
	async index() {
		...
		data.breadcrumbs.push({
			...
			href: await this.url.link('extension/opencart/module/filter', 'user_token=' + this.session.data.user_token)
		});

		data.save = await this.url.link('extension/opencart/module/filter.save', 'user_token=' + this.session.data.user_token);

global['OpencartAdminControllerExtensionOpencartModuleInformation'] = class Information extends global['OpencartSystemEngineController'] {
	...
	async index() {
        ...
        data.breadcrumbs.push({
            ...
            href: await this.url.link('extension/opencart/module/information', 'user_token=' + this.session.data.user_token)
        });

        data.save = await this.url.link('extension/opencart/module/information.save', 'user_token=' + this.session.data.user_token);
    ...
    async save() {
        ...
        if (!await this.user.hasPermission('modify', 'extension/opencart/module/information')) {

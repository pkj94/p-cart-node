global['\Opencart\Catalog\Controller\Extension\Opencart\Module\Bestseller'] = class Bestseller extends global['\Opencart\System\Engine\Controller'] {
	...
	async index(setting) {
		...
		const results = await this.model_extension_opencart_module_bestseller.getBestSellers(setting['limit']);
		...
		if (results.length) {
			...
			return await this.load.view('extension/opencart/module/bestseller', data);
		} else {
			return '';
		}
	}

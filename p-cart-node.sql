...
--
-- Dumping data for table `pc_address_format`
--

INSERT INTO `pc_address_format` (`address_format_id`, `name`, `address_format`) VALUES
...
--
-- Dumping data for table `pc_attribute`
--

INSERT INTO `pc_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Dumping data for table `pc_attribute_description`
--

INSERT INTO `pc_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(3, 1, 'Clockspeed'),
(4, 1, 'test 1'),
...
--
-- Dumping data for table `pc_attribute_group`
--

INSERT INTO `pc_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Dumping data for table `pc_attribute_group_description`
--

INSERT INTO `pc_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Dumping data for table `pc_banner`
--

INSERT INTO `pc_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- Dumping data for table `pc_banner_image`
--
...
INSERT INTO `pc_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pc_category_description`
--

INSERT INTO `pc_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Dumping data for table `pc_category_path`
--

INSERT INTO `pc_category_path` (`category_id`, `path_id`, `level`) VALUES
(17, 17, 0),
(18, 18, 0),
(20, 20, 0),
(24, 24, 0),
...
--
-- Dumping data for table `pc_category_to_store`
--

INSERT INTO `pc_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Dumping data for table `pc_country`
--

INSERT INTO `pc_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format_id`, `postcode_required`, `status`) VALUES
...
--
-- Dumping data for table `pc_coupon`
--

INSERT INTO `pc_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Dumping data for table `pc_cron`
--

INSERT INTO `pc_cron` (`cron_id`, `code`, `description`, `cycle`, `action`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pc_currency`
--
...
--
-- Dumping data for table `pc_customer_group`
--
...
--
-- Dumping data for table `pc_customer_group_description`
--

INSERT INTO `pc_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');
...
--
-- Dumping data for table `pc_custom_field`
--
...
--
-- Dumping data for table `pc_custom_field_customer_group`
--

INSERT INTO `pc_custom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 1, 1),
(4, 1, 1),
...
--
-- Dumping data for table `pc_custom_field_description`
--
...
--
-- Dumping data for table `pc_custom_field_value`
--

INSERT INTO `pc_custom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
--
-- Dumping data for table `pc_custom_field_value_description`
--

INSERT INTO `pc_custom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`) VALUES
(1, 1, 1, 'Test 1'),
(2, 1, 1, 'test 2'),
(3, 1, 1, 'Test 3'),
(4, 1, 2, 'Test 1'),
...
--
-- Dumping data for table `pc_event`
--

INSERT INTO `pc_event` (`event_id`, `code`, `description`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Dumping data for table `pc_extension`
--

INSERT INTO `pc_extension` (`extension_id`, `extension`, `type`, `code`) VALUES
...
--
-- Dumping data for table `pc_extension_install`
--
...
--
-- Dumping data for table `pc_extension_path`
--

INSERT INTO `pc_extension_path` (`extension_path_id`, `extension_install_id`, `path`) VALUES
(1, 1, 'opencart'),
(2, 1, 'opencart/admin'),
...
(7, 1, 'opencart/admin/controller/captcha/basic.js'),
(8, 1, 'opencart/admin/controller/currency'),
(9, 1, 'opencart/admin/controller/currency/ecb.js'),
(10, 1, 'opencart/admin/controller/currency/fixer.js'),
(11, 1, 'opencart/admin/controller/dashboard'),
(12, 1, 'opencart/admin/controller/dashboard/activity.js'),
(13, 1, 'opencart/admin/controller/dashboard/chart.js'),
(14, 1, 'opencart/admin/controller/dashboard/customer.js'),
(15, 1, 'opencart/admin/controller/dashboard/map.js'),
(16, 1, 'opencart/admin/controller/dashboard/online.js'),
(17, 1, 'opencart/admin/controller/dashboard/order.js'),
(18, 1, 'opencart/admin/controller/dashboard/recent.js'),
(19, 1, 'opencart/admin/controller/dashboard/sale.js'),
(20, 1, 'opencart/admin/controller/feed'),
(21, 1, 'opencart/admin/controller/feed/index.html'),
(22, 1, 'opencart/admin/controller/fraud'),
(23, 1, 'opencart/admin/controller/fraud/ip.js'),
(24, 1, 'opencart/admin/controller/module'),
(25, 1, 'opencart/admin/controller/module/account.js'),
(26, 1, 'opencart/admin/controller/module/banner.js'),
(27, 1, 'opencart/admin/controller/module/bestseller.js'),
(28, 1, 'opencart/admin/controller/module/category.js'),
(29, 1, 'opencart/admin/controller/module/featured.js'),
(30, 1, 'opencart/admin/controller/module/filter.js'),
(31, 1, 'opencart/admin/controller/module/html.js'),
(32, 1, 'opencart/admin/controller/module/information.js'),
(33, 1, 'opencart/admin/controller/module/latest.js'),
(34, 1, 'opencart/admin/controller/module/special.js'),
(35, 1, 'opencart/admin/controller/module/store.js'),
(36, 1, 'opencart/admin/controller/payment'),
(37, 1, 'opencart/admin/controller/payment/bank_transfer.js'),
(38, 1, 'opencart/admin/controller/payment/cheque.js'),
(39, 1, 'opencart/admin/controller/payment/cod.js'),
(40, 1, 'opencart/admin/controller/payment/free_checkout.js'),
(41, 1, 'opencart/admin/controller/report'),
(42, 1, 'opencart/admin/controller/report/customer.js'),
(43, 1, 'opencart/admin/controller/report/customer_activity.js'),
(44, 1, 'opencart/admin/controller/report/customer_order.js'),
(45, 1, 'opencart/admin/controller/report/customer_reward.js'),
(46, 1, 'opencart/admin/controller/report/customer_search.js'),
(47, 1, 'opencart/admin/controller/report/customer_subscription.js'),
(48, 1, 'opencart/admin/controller/report/customer_transaction.js'),
(49, 1, 'opencart/admin/controller/report/marketing.js'),
(50, 1, 'opencart/admin/controller/report/product_purchased.js'),
(51, 1, 'opencart/admin/controller/report/product_viewed.js'),
(52, 1, 'opencart/admin/controller/report/sale_coupon.js'),
(53, 1, 'opencart/admin/controller/report/sale_order.js'),
(54, 1, 'opencart/admin/controller/report/sale_return.js'),
(55, 1, 'opencart/admin/controller/report/sale_shipping.js'),
(56, 1, 'opencart/admin/controller/report/sale_tax.js'),
(57, 1, 'opencart/admin/controller/shipping'),
(58, 1, 'opencart/admin/controller/shipping/flat.js'),
(59, 1, 'opencart/admin/controller/shipping/free.js'),
(60, 1, 'opencart/admin/controller/shipping/item.js'),
(61, 1, 'opencart/admin/controller/shipping/pickup.js'),
(62, 1, 'opencart/admin/controller/shipping/weight.js'),
(63, 1, 'opencart/admin/controller/theme'),
(64, 1, 'opencart/admin/controller/theme/basic.js'),
(65, 1, 'opencart/admin/controller/total'),
(66, 1, 'opencart/admin/controller/total/coupon.js'),
(67, 1, 'opencart/admin/controller/total/credit.js'),
(68, 1, 'opencart/admin/controller/total/handling.js'),
(69, 1, 'opencart/admin/controller/total/low_order_fee.js'),
(70, 1, 'opencart/admin/controller/total/reward.js'),
(71, 1, 'opencart/admin/controller/total/shipping.js'),
(72, 1, 'opencart/admin/controller/total/sub_total.js'),
(73, 1, 'opencart/admin/controller/total/tax.js'),
(74, 1, 'opencart/admin/controller/total/total.js'),
(75, 1, 'opencart/admin/controller/total/voucher.js'),
(76, 1, 'opencart/admin/language'),
(77, 1, 'opencart/admin/language/en-gb'),
(78, 1, 'opencart/admin/language/en-gb/captcha'),
(79, 1, 'opencart/admin/language/en-gb/captcha/basic.js'),
(80, 1, 'opencart/admin/language/en-gb/currency'),
(81, 1, 'opencart/admin/language/en-gb/currency/ecb.js'),
(82, 1, 'opencart/admin/language/en-gb/currency/fixer.js'),
(83, 1, 'opencart/admin/language/en-gb/dashboard'),
(84, 1, 'opencart/admin/language/en-gb/dashboard/activity.js'),
(85, 1, 'opencart/admin/language/en-gb/dashboard/chart.js'),
(86, 1, 'opencart/admin/language/en-gb/dashboard/customer.js'),
(87, 1, 'opencart/admin/language/en-gb/dashboard/map.js'),
(88, 1, 'opencart/admin/language/en-gb/dashboard/online.js'),
(89, 1, 'opencart/admin/language/en-gb/dashboard/order.js'),
(90, 1, 'opencart/admin/language/en-gb/dashboard/recent.js'),
(91, 1, 'opencart/admin/language/en-gb/dashboard/sale.js'),
(92, 1, 'opencart/admin/language/en-gb/fraud'),
(93, 1, 'opencart/admin/language/en-gb/fraud/ip.js'),
(94, 1, 'opencart/admin/language/en-gb/module'),
(95, 1, 'opencart/admin/language/en-gb/module/account.js'),
(96, 1, 'opencart/admin/language/en-gb/module/banner.js'),
(97, 1, 'opencart/admin/language/en-gb/module/bestseller.js'),
(98, 1, 'opencart/admin/language/en-gb/module/category.js'),
(99, 1, 'opencart/admin/language/en-gb/module/featured.js'),
(100, 1, 'opencart/admin/language/en-gb/module/filter.js'),
(101, 1, 'opencart/admin/language/en-gb/module/html.js'),
(102, 1, 'opencart/admin/language/en-gb/module/information.js'),
(103, 1, 'opencart/admin/language/en-gb/module/latest.js'),
(104, 1, 'opencart/admin/language/en-gb/module/special.js'),
(105, 1, 'opencart/admin/language/en-gb/module/store.js'),
(106, 1, 'opencart/admin/language/en-gb/payment'),
(107, 1, 'opencart/admin/language/en-gb/payment/bank_transfer.js'),
(108, 1, 'opencart/admin/language/en-gb/payment/cheque.js'),
(109, 1, 'opencart/admin/language/en-gb/payment/cod.js'),
(110, 1, 'opencart/admin/language/en-gb/payment/free_checkout.js'),
(111, 1, 'opencart/admin/language/en-gb/report'),
(112, 1, 'opencart/admin/language/en-gb/report/customer.js'),
(113, 1, 'opencart/admin/language/en-gb/report/customer_activity.js'),
(114, 1, 'opencart/admin/language/en-gb/report/customer_order.js'),
(115, 1, 'opencart/admin/language/en-gb/report/customer_reward.js'),
(116, 1, 'opencart/admin/language/en-gb/report/customer_search.js'),
(117, 1, 'opencart/admin/language/en-gb/report/customer_subscription.js'),
(118, 1, 'opencart/admin/language/en-gb/report/customer_transaction.js'),
(119, 1, 'opencart/admin/language/en-gb/report/marketing.js'),
(120, 1, 'opencart/admin/language/en-gb/report/product_purchased.js'),
(121, 1, 'opencart/admin/language/en-gb/report/product_viewed.js'),
(122, 1, 'opencart/admin/language/en-gb/report/sale_coupon.js'),
(123, 1, 'opencart/admin/language/en-gb/report/sale_order.js'),
(124, 1, 'opencart/admin/language/en-gb/report/sale_return.js'),
(125, 1, 'opencart/admin/language/en-gb/report/sale_shipping.js'),
(126, 1, 'opencart/admin/language/en-gb/report/sale_tax.js'),
(127, 1, 'opencart/admin/language/en-gb/shipping'),
(128, 1, 'opencart/admin/language/en-gb/shipping/flat.js'),
(129, 1, 'opencart/admin/language/en-gb/shipping/free.js'),
(130, 1, 'opencart/admin/language/en-gb/shipping/item.js'),
(131, 1, 'opencart/admin/language/en-gb/shipping/pickup.js'),
(132, 1, 'opencart/admin/language/en-gb/shipping/weight.js'),
(133, 1, 'opencart/admin/language/en-gb/theme'),
(134, 1, 'opencart/admin/language/en-gb/theme/basic.js'),
(135, 1, 'opencart/admin/language/en-gb/total'),
(136, 1, 'opencart/admin/language/en-gb/total/coupon.js'),
(137, 1, 'opencart/admin/language/en-gb/total/credit.js'),
(138, 1, 'opencart/admin/language/en-gb/total/handling.js'),
(139, 1, 'opencart/admin/language/en-gb/total/low_order_fee.js'),
(140, 1, 'opencart/admin/language/en-gb/total/reward.js'),
(141, 1, 'opencart/admin/language/en-gb/total/shipping.js'),
(142, 1, 'opencart/admin/language/en-gb/total/sub_total.js'),
(143, 1, 'opencart/admin/language/en-gb/total/tax.js'),
(144, 1, 'opencart/admin/language/en-gb/total/total.js'),
(145, 1, 'opencart/admin/language/en-gb/total/voucher.js'),
(146, 1, 'opencart/admin/model'),
(147, 1, 'opencart/admin/model/dashboard'),
(148, 1, 'opencart/admin/model/dashboard/map.js'),
(149, 1, 'opencart/admin/model/fraud'),
(150, 1, 'opencart/admin/model/fraud/ip.js'),
(151, 1, 'opencart/admin/model/module'),
(152, 1, 'opencart/admin/model/module/bestseller.js'),
(153, 1, 'opencart/admin/model/report'),
(154, 1, 'opencart/admin/model/report/activity.js'),
(155, 1, 'opencart/admin/model/report/coupon.js'),
(156, 1, 'opencart/admin/model/report/customer.js'),
(157, 1, 'opencart/admin/model/report/customer_subscription.js'),
(158, 1, 'opencart/admin/model/report/customer_transaction.js'),
(159, 1, 'opencart/admin/model/report/marketing.js'),
(160, 1, 'opencart/admin/model/report/product_purchased.js'),
(161, 1, 'opencart/admin/model/report/product_viewed.js'),
(162, 1, 'opencart/admin/model/report/returns.js'),
(163, 1, 'opencart/admin/model/report/sale.js'),
...
(281, 1, 'opencart/catalog/controller/captcha/basic.js'),
(282, 1, 'opencart/catalog/controller/currency'),
(283, 1, 'opencart/catalog/controller/currency/ecb.js'),
(284, 1, 'opencart/catalog/controller/currency/fixer.js'),
(285, 1, 'opencart/catalog/controller/module'),
(286, 1, 'opencart/catalog/controller/module/account.js'),
(287, 1, 'opencart/catalog/controller/module/banner.js'),
(288, 1, 'opencart/catalog/controller/module/bestseller.js'),
(289, 1, 'opencart/catalog/controller/module/category.js'),
(290, 1, 'opencart/catalog/controller/module/featured.js'),
(291, 1, 'opencart/catalog/controller/module/filter.js'),
(292, 1, 'opencart/catalog/controller/module/html.js'),
(293, 1, 'opencart/catalog/controller/module/information.js'),
(294, 1, 'opencart/catalog/controller/module/latest.js'),
(295, 1, 'opencart/catalog/controller/module/special.js'),
(296, 1, 'opencart/catalog/controller/module/store.js'),
(297, 1, 'opencart/catalog/controller/payment'),
(298, 1, 'opencart/catalog/controller/payment/bank_transfer.js'),
(299, 1, 'opencart/catalog/controller/payment/cheque.js'),
(300, 1, 'opencart/catalog/controller/payment/cod.js'),
(301, 1, 'opencart/catalog/controller/payment/free_checkout.js'),
(302, 1, 'opencart/catalog/controller/total'),
(303, 1, 'opencart/catalog/controller/total/coupon.js'),
(304, 1, 'opencart/catalog/controller/total/reward.js'),
(305, 1, 'opencart/catalog/controller/total/shipping.js'),
(306, 1, 'opencart/catalog/controller/total/voucher.js'),
(307, 1, 'opencart/catalog/language'),
(308, 1, 'opencart/catalog/language/de-de'),
(309, 1, 'opencart/catalog/language/de-de/module'),
(310, 1, 'opencart/catalog/language/de-de/module/featured.js'),
(311, 1, 'opencart/catalog/language/de-de/payment'),
(312, 1, 'opencart/catalog/language/de-de/payment/cod.js'),
(313, 1, 'opencart/catalog/language/en-gb'),
(314, 1, 'opencart/catalog/language/en-gb/captcha'),
(315, 1, 'opencart/catalog/language/en-gb/captcha/basic.js'),
(316, 1, 'opencart/catalog/language/en-gb/module'),
(317, 1, 'opencart/catalog/language/en-gb/module/account.js'),
(318, 1, 'opencart/catalog/language/en-gb/module/bestseller.js'),
(319, 1, 'opencart/catalog/language/en-gb/module/category.js'),
(320, 1, 'opencart/catalog/language/en-gb/module/featured.js'),
(321, 1, 'opencart/catalog/language/en-gb/module/filter.js'),
(322, 1, 'opencart/catalog/language/en-gb/module/information.js'),
(323, 1, 'opencart/catalog/language/en-gb/module/latest.js'),
(324, 1, 'opencart/catalog/language/en-gb/module/special.js'),
(325, 1, 'opencart/catalog/language/en-gb/module/store.js'),
(326, 1, 'opencart/catalog/language/en-gb/payment'),
(327, 1, 'opencart/catalog/language/en-gb/payment/bank_transfer.js'),
(328, 1, 'opencart/catalog/language/en-gb/payment/cheque.js'),
(329, 1, 'opencart/catalog/language/en-gb/payment/cod.js'),
(330, 1, 'opencart/catalog/language/en-gb/payment/free_checkout.js'),
(331, 1, 'opencart/catalog/language/en-gb/shipping'),
(332, 1, 'opencart/catalog/language/en-gb/shipping/flat.js'),
(333, 1, 'opencart/catalog/language/en-gb/shipping/free.js'),
(334, 1, 'opencart/catalog/language/en-gb/shipping/item.js'),
(335, 1, 'opencart/catalog/language/en-gb/shipping/pickup.js'),
(336, 1, 'opencart/catalog/language/en-gb/shipping/weight.js'),
(337, 1, 'opencart/catalog/language/en-gb/total'),
(338, 1, 'opencart/catalog/language/en-gb/total/coupon.js'),
(339, 1, 'opencart/catalog/language/en-gb/total/credit.js'),
(340, 1, 'opencart/catalog/language/en-gb/total/handling.js'),
(341, 1, 'opencart/catalog/language/en-gb/total/low_order_fee.js'),
(342, 1, 'opencart/catalog/language/en-gb/total/reward.js'),
(343, 1, 'opencart/catalog/language/en-gb/total/shipping.js'),
(344, 1, 'opencart/catalog/language/en-gb/total/sub_total.js'),
(345, 1, 'opencart/catalog/language/en-gb/total/total.js'),
(346, 1, 'opencart/catalog/language/en-gb/total/voucher.js'),
(347, 1, 'opencart/catalog/model'),
(348, 1, 'opencart/catalog/model/fraud'),
(349, 1, 'opencart/catalog/model/fraud/ip.js'),
(350, 1, 'opencart/catalog/model/module'),
(351, 1, 'opencart/catalog/model/module/bestseller.js'),
(352, 1, 'opencart/catalog/model/module/latest.js'),
(353, 1, 'opencart/catalog/model/payment'),
(354, 1, 'opencart/catalog/model/payment/bank_transfer.js'),
(355, 1, 'opencart/catalog/model/payment/cheque.js'),
(356, 1, 'opencart/catalog/model/payment/cod.js'),
(357, 1, 'opencart/catalog/model/payment/free_checkout.js'),
(358, 1, 'opencart/catalog/model/shipping'),
(359, 1, 'opencart/catalog/model/shipping/flat.js'),
(360, 1, 'opencart/catalog/model/shipping/free.js'),
(361, 1, 'opencart/catalog/model/shipping/item.js'),
(362, 1, 'opencart/catalog/model/shipping/pickup.js'),
(363, 1, 'opencart/catalog/model/shipping/weight.js'),
(364, 1, 'opencart/catalog/model/total'),
(365, 1, 'opencart/catalog/model/total/coupon.js'),
(366, 1, 'opencart/catalog/model/total/credit.js'),
(367, 1, 'opencart/catalog/model/total/handling.js'),
(368, 1, 'opencart/catalog/model/total/low_order_fee.js'),
(369, 1, 'opencart/catalog/model/total/reward.js'),
(370, 1, 'opencart/catalog/model/total/shipping.js'),
(371, 1, 'opencart/catalog/model/total/sub_total.js'),
(372, 1, 'opencart/catalog/model/total/tax.js'),
(373, 1, 'opencart/catalog/model/total/total.js'),
(374, 1, 'opencart/catalog/model/total/voucher.js'),
...
--
-- Dumping data for table `pc_geo_zone`
--

INSERT INTO `pc_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pc_information`
--

INSERT INTO `pc_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(1, 1, 3, 1),
(2, 1, 1, 1),
(3, 1, 4, 1),
(4, 1, 2, 1);
...
--
-- Dumping data for table `pc_information_description`
--
...
--
-- Dumping data for table `pc_information_to_store`
--

INSERT INTO `pc_information_to_store` (`information_id`, `store_id`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0);
...
--
-- Dumping data for table `pc_language`
--

INSERT INTO `pc_language` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
...
INSERT INTO `pc_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Dumping data for table `pc_layout_module`
--
...
--
-- Dumping data for table `pc_layout_route`
--
...
--
-- Dumping data for table `pc_length_class`
--

INSERT INTO `pc_length_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000);
...
--
-- Dumping data for table `pc_length_class_description`
--

INSERT INTO `pc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Dumping data for table `pc_manufacturer`
--

INSERT INTO `pc_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Dumping data for table `pc_manufacturer_to_store`
--

INSERT INTO `pc_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Dumping data for table `pc_option`
--

INSERT INTO `pc_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Dumping data for table `pc_option_description`
--

INSERT INTO `pc_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(5, 1, 'Select'),
...
--
-- Dumping data for table `pc_option_value`
--

INSERT INTO `pc_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(23, 2, '', 1),
(24, 2, '', 2),
(31, 1, '', 2),
(32, 1, '', 1),
...
--
-- Dumping data for table `pc_option_value_description`
--

INSERT INTO `pc_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(23, 1, 2, 'Checkbox 1'),
(24, 1, 2, 'Checkbox 2'),
(31, 1, 1, 'Medium'),
(32, 1, 1, 'Small'),
...
--
-- Dumping data for table `pc_order_status`
--

INSERT INTO `pc_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(5, 1, 'Complete'),
...
--
-- Dumping data for table `pc_product`
--
...
--
-- Dumping data for table `pc_product_attribute`
--

INSERT INTO `pc_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(42, 3, 1, '100mhz'),
(43, 2, 1, '1'),
(43, 4, 1, '8gb'),
(47, 2, 1, '4'),
...
--
-- Dumping data for table `pc_product_description`
--

INSERT INTO `pc_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Dumping data for table `pc_product_discount`
--
...
--
-- Dumping data for table `pc_product_image`
--

INSERT INTO `pc_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Dumping data for table `pc_product_option`
--
...
--
-- Dumping data for table `pc_product_option_value`
--
...
--
-- Dumping data for table `pc_product_related`
--
...
--
-- Dumping data for table `pc_product_reward`
--

INSERT INTO `pc_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(329, 43, 1, 600),
(331, 44, 1, 700),
(333, 45, 1, 800),
(335, 40, 1, 0),
...
--
-- Dumping data for table `pc_product_special`
--
...
--
-- Dumping data for table `pc_product_to_category`
--

INSERT INTO `pc_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- Dumping data for table `pc_product_to_store`
--

INSERT INTO `pc_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Dumping data for table `pc_return_action`
--

INSERT INTO `pc_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Dumping data for table `pc_return_reason`
--

INSERT INTO `pc_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Dumping data for table `pc_return_status`
--

INSERT INTO `pc_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
...
--
-- Dumping data for table `pc_seo_url`
--

INSERT INTO `pc_seo_url` (`seo_url_id`, `store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`) VALUES
...
--
-- Dumping data for table `pc_setting`
--
...
--
-- Dumping data for table `pc_statistics`
--

INSERT INTO `pc_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', 0.0000),
...
--
-- Dumping data for table `pc_stock_status`
--

INSERT INTO `pc_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days'),
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order');
...
--
-- Dumping data for table `pc_subscription_plan`
--
...
--
-- Dumping data for table `pc_subscription_plan_description`
--

INSERT INTO `pc_subscription_plan_description` (`subscription_plan_id`, `language_id`, `name`) VALUES
...
--
-- Dumping data for table `pc_subscription_status`
--

INSERT INTO `pc_subscription_status` (`subscription_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Active'),
(3, 1, 'Expired'),
(4, 1, 'Suspended'),
...
--
-- Dumping data for table `pc_tax_class`
--

INSERT INTO `pc_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pc_tax_rate`
--

INSERT INTO `pc_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `pc_tax_rate_to_customer_group`
--

INSERT INTO `pc_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Dumping data for table `pc_tax_rule`
--

INSERT INTO `pc_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(120, 10, 87, 'store', 0),
(121, 10, 86, 'payment', 1),
(127, 9, 87, 'shipping', 2),
(128, 9, 86, 'shipping', 1);
...
--
-- Dumping data for table `pc_user_group`
--
...
--
-- Dumping data for table `pc_user_login`
--
...
--
-- Dumping data for table `pc_voucher_theme`
--
...
--
-- Dumping data for table `pc_voucher_theme_description`
--

INSERT INTO `pc_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Dumping data for table `pc_weight_class`
--

INSERT INTO `pc_weight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000),
(5, 2.20460000),
(6, 35.27400000),
...
--
-- Dumping data for table `pc_weight_class_description`
--

INSERT INTO `pc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Dumping data for table `pc_zone`
--

INSERT INTO `pc_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Dumping data for table `pc_zone_to_geo_zone`
--

INSERT INTO `pc_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
--
-- Indexes for table `pc_address_format`
--
ALTER TABLE `pc_address_format`
  ADD PRIMARY KEY (`address_format_id`);

--
-- Indexes for table `pc_antispam`
--
ALTER TABLE `pc_antispam`
  ADD PRIMARY KEY (`antispam_id`),
  ADD KEY `keyword` (`keyword`);

--
-- Indexes for table `pc_api`
--
ALTER TABLE `pc_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `pc_api_ip`
--
ALTER TABLE `pc_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indexes for table `pc_api_session`
--
ALTER TABLE `pc_api_session`
  ADD PRIMARY KEY (`api_session_id`);

--
-- Indexes for table `pc_article`
--
ALTER TABLE `pc_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `pc_article_comment`
--
ALTER TABLE `pc_article_comment`
  ADD PRIMARY KEY (`article_comment_id`),
  ADD KEY `article_id` (`article_id`);

--
-- Indexes for table `pc_article_description`
--
ALTER TABLE `pc_article_description`
  ADD PRIMARY KEY (`article_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `pc_article_to_layout`
--
ALTER TABLE `pc_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `pc_article_to_store`
--
ALTER TABLE `pc_article_to_store`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `pc_attribute`
--
ALTER TABLE `pc_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indexes for table `pc_attribute_description`
--
ALTER TABLE `pc_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indexes for table `pc_attribute_group`
--
ALTER TABLE `pc_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indexes for table `pc_attribute_group_description`
--
ALTER TABLE `pc_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indexes for table `pc_banner`
--
ALTER TABLE `pc_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indexes for table `pc_banner_image`
--
...
--
-- Indexes for table `pc_category_description`
--
ALTER TABLE `pc_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `pc_category_filter`
--
ALTER TABLE `pc_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `pc_category_path`
--
ALTER TABLE `pc_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `pc_category_to_layout`
--
ALTER TABLE `pc_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `pc_category_to_store`
--
ALTER TABLE `pc_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `pc_country`
--
ALTER TABLE `pc_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indexes for table `pc_coupon`
--
ALTER TABLE `pc_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `pc_coupon_category`
--
ALTER TABLE `pc_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indexes for table `pc_coupon_history`
--
ALTER TABLE `pc_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indexes for table `pc_coupon_product`
--
ALTER TABLE `pc_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indexes for table `pc_cron`
--
ALTER TABLE `pc_cron`
  ADD PRIMARY KEY (`cron_id`);

--
-- Indexes for table `pc_currency`
--
ALTER TABLE `pc_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indexes for table `pc_customer`
--
ALTER TABLE `pc_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `pc_customer_activity`
--
ALTER TABLE `pc_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Indexes for table `pc_customer_affiliate`
--
ALTER TABLE `pc_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `pc_customer_affiliate_report`
--
ALTER TABLE `pc_customer_affiliate_report`
  ADD PRIMARY KEY (`customer_affiliate_report_id`);

--
-- Indexes for table `pc_customer_approval`
--
ALTER TABLE `pc_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- Indexes for table `pc_customer_group`
--
ALTER TABLE `pc_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indexes for table `pc_customer_group_description`
--
ALTER TABLE `pc_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indexes for table `pc_customer_history`
--
ALTER TABLE `pc_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indexes for table `pc_customer_ip`
--
...
--
-- Indexes for table `pc_customer_login`
--
...
--
-- Indexes for table `pc_customer_online`
--
ALTER TABLE `pc_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indexes for table `pc_customer_reward`
--
ALTER TABLE `pc_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indexes for table `pc_customer_search`
--
ALTER TABLE `pc_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Indexes for table `pc_customer_transaction`
--
ALTER TABLE `pc_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indexes for table `pc_customer_wishlist`
--
ALTER TABLE `pc_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- Indexes for table `pc_custom_field`
--
ALTER TABLE `pc_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indexes for table `pc_custom_field_customer_group`
--
ALTER TABLE `pc_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indexes for table `pc_custom_field_description`
--
ALTER TABLE `pc_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indexes for table `pc_custom_field_value`
--
ALTER TABLE `pc_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indexes for table `pc_custom_field_value_description`
--
ALTER TABLE `pc_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indexes for table `pc_download`
--
ALTER TABLE `pc_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indexes for table `pc_download_description`
--
ALTER TABLE `pc_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indexes for table `pc_download_report`
--
ALTER TABLE `pc_download_report`
  ADD PRIMARY KEY (`download_report_id`);

--
-- Indexes for table `pc_event`
--
ALTER TABLE `pc_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indexes for table `pc_extension`
--
ALTER TABLE `pc_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indexes for table `pc_extension_install`
--
ALTER TABLE `pc_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Indexes for table `pc_extension_path`
--
ALTER TABLE `pc_extension_path`
  ADD PRIMARY KEY (`extension_path_id`),
  ADD KEY `path` (`path`);

--
-- Indexes for table `pc_filter`
--
ALTER TABLE `pc_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `pc_filter_description`
--
ALTER TABLE `pc_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indexes for table `pc_filter_group`
--
ALTER TABLE `pc_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indexes for table `pc_filter_group_description`
--
ALTER TABLE `pc_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indexes for table `pc_gdpr`
--
ALTER TABLE `pc_gdpr`
  ADD PRIMARY KEY (`gdpr_id`);

--
-- Indexes for table `pc_geo_zone`
--
ALTER TABLE `pc_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indexes for table `pc_information`
--
ALTER TABLE `pc_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indexes for table `pc_information_description`
--
ALTER TABLE `pc_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indexes for table `pc_information_to_layout`
--
ALTER TABLE `pc_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `pc_information_to_store`
--
ALTER TABLE `pc_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `pc_language`
--
...
--
-- Indexes for table `pc_layout`
--
ALTER TABLE `pc_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indexes for table `pc_layout_module`
--
ALTER TABLE `pc_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indexes for table `pc_layout_route`
--
ALTER TABLE `pc_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indexes for table `pc_length_class`
--
ALTER TABLE `pc_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indexes for table `pc_length_class_description`
--
ALTER TABLE `pc_length_class_description`
...
--
-- Indexes for table `pc_manufacturer`
--
ALTER TABLE `pc_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indexes for table `pc_manufacturer_to_layout`
--
ALTER TABLE `pc_manufacturer_to_layout`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `pc_manufacturer_to_store`
--
ALTER TABLE `pc_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `pc_marketing`
--
ALTER TABLE `pc_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `pc_marketing_report`
--
ALTER TABLE `pc_marketing_report`
  ADD PRIMARY KEY (`marketing_report_id`);

--
-- Indexes for table `pc_module`
--
ALTER TABLE `pc_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indexes for table `pc_notification`
--
ALTER TABLE `pc_notification`
  ADD PRIMARY KEY (`notification_id`);

--
-- Indexes for table `pc_option`
--
ALTER TABLE `pc_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indexes for table `pc_option_description`
--
ALTER TABLE `pc_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indexes for table `pc_option_value`
--
ALTER TABLE `pc_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indexes for table `pc_option_value_description`
--
ALTER TABLE `pc_option_value_description`
...
--
-- Indexes for table `pc_order_history`
--
ALTER TABLE `pc_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indexes for table `pc_order_option`
--
ALTER TABLE `pc_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indexes for table `pc_order_product`
--
ALTER TABLE `pc_order_product`
  ADD PRIMARY KEY (`order_product_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `pc_order_status`
--
ALTER TABLE `pc_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indexes for table `pc_order_subscription`
--
ALTER TABLE `pc_order_subscription`
  ADD PRIMARY KEY (`order_subscription_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `pc_order_total`
--
ALTER TABLE `pc_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `pc_order_voucher`
--
ALTER TABLE `pc_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Indexes for table `pc_product`
--
ALTER TABLE `pc_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `pc_product_attribute`
--
ALTER TABLE `pc_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indexes for table `pc_product_description`
--
ALTER TABLE `pc_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `pc_product_discount`
--
...
--
-- Indexes for table `pc_product_filter`
--
ALTER TABLE `pc_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indexes for table `pc_product_image`
--
...
--
-- Indexes for table `pc_product_option`
--
ALTER TABLE `pc_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indexes for table `pc_product_option_value`
--
ALTER TABLE `pc_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indexes for table `pc_product_related`
--
ALTER TABLE `pc_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indexes for table `pc_product_report`
--
ALTER TABLE `pc_product_report`
  ADD PRIMARY KEY (`product_report_id`);

--
-- Indexes for table `pc_product_reward`
--
ALTER TABLE `pc_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indexes for table `pc_product_special`
--
...
--
-- Indexes for table `pc_product_subscription`
--
ALTER TABLE `pc_product_subscription`
  ADD PRIMARY KEY (`product_id`,`subscription_plan_id`,`customer_group_id`);

--
-- Indexes for table `pc_product_to_category`
--
ALTER TABLE `pc_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `pc_product_to_download`
--
ALTER TABLE `pc_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indexes for table `pc_product_to_layout`
--
ALTER TABLE `pc_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `pc_product_to_store`
--
ALTER TABLE `pc_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `pc_product_viewed`
--
ALTER TABLE `pc_product_viewed`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `pc_return`
--
ALTER TABLE `pc_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indexes for table `pc_return_action`
--
ALTER TABLE `pc_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indexes for table `pc_return_history`
--
ALTER TABLE `pc_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indexes for table `pc_return_reason`
--
ALTER TABLE `pc_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indexes for table `pc_return_status`
--
ALTER TABLE `pc_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indexes for table `pc_review`
--
...
--
-- Indexes for table `pc_session`
--
ALTER TABLE `pc_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `expire` (`expire`);

--
-- Indexes for table `pc_setting`
--
ALTER TABLE `pc_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `pc_startup`
--
ALTER TABLE `pc_startup`
  ADD PRIMARY KEY (`startup_id`);

--
-- Indexes for table `pc_statistics`
--
ALTER TABLE `pc_statistics`
  ADD PRIMARY KEY (`statistics_id`);

--
-- Indexes for table `pc_stock_status`
--
...
--
-- Indexes for table `pc_subscription`
--
...
--
-- Indexes for table `pc_subscription_history`
--
ALTER TABLE `pc_subscription_history`
  ADD PRIMARY KEY (`subscription_history_id`);

--
-- Indexes for table `pc_subscription_plan`
--
ALTER TABLE `pc_subscription_plan`
  ADD PRIMARY KEY (`subscription_plan_id`);

--
-- Indexes for table `pc_subscription_plan_description`
--
ALTER TABLE `pc_subscription_plan_description`
  ADD PRIMARY KEY (`subscription_plan_id`,`language_id`);

--
-- Indexes for table `pc_subscription_status`
--
ALTER TABLE `pc_subscription_status`
  ADD PRIMARY KEY (`subscription_status_id`,`language_id`);

--
-- Indexes for table `pc_tax_class`
--
ALTER TABLE `pc_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indexes for table `pc_tax_rate`
--
ALTER TABLE `pc_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indexes for table `pc_tax_rate_to_customer_group`
--
ALTER TABLE `pc_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indexes for table `pc_tax_rule`
--
ALTER TABLE `pc_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indexes for table `pc_theme`
--
ALTER TABLE `pc_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Indexes for table `pc_topic`
--
ALTER TABLE `pc_topic`
  ADD PRIMARY KEY (`topic_id`);

--
-- Indexes for table `pc_topic_description`
--
ALTER TABLE `pc_topic_description`
  ADD PRIMARY KEY (`topic_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `pc_topic_to_store`
--
ALTER TABLE `pc_topic_to_store`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Indexes for table `pc_translation`
--
ALTER TABLE `pc_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Indexes for table `pc_upload`
--
ALTER TABLE `pc_upload`
...
--
-- Indexes for table `pc_user_authorize`
--
ALTER TABLE `pc_user_authorize`
  ADD PRIMARY KEY (`user_authorize_id`);

--
-- Indexes for table `pc_user_group`
--
ALTER TABLE `pc_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Indexes for table `pc_user_login`
--
ALTER TABLE `pc_user_login`
  ADD PRIMARY KEY (`user_login_id`);

--
-- Indexes for table `pc_voucher`
--
ALTER TABLE `pc_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Indexes for table `pc_voucher_history`
--
ALTER TABLE `pc_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Indexes for table `pc_voucher_theme`
--
ALTER TABLE `pc_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Indexes for table `pc_voucher_theme_description`
--
ALTER TABLE `pc_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Indexes for table `pc_weight_class`
--
ALTER TABLE `pc_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indexes for table `pc_weight_class_description`
--
ALTER TABLE `pc_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indexes for table `pc_zone`
--
ALTER TABLE `pc_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indexes for table `pc_zone_to_geo_zone`
--
...
--
-- AUTO_INCREMENT for table `pc_article`
--
ALTER TABLE `pc_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_article_comment`
--
ALTER TABLE `pc_article_comment`
...
--
-- AUTO_INCREMENT for table `pc_customer_affiliate_report`
--
ALTER TABLE `pc_customer_affiliate_report`
...
--
-- AUTO_INCREMENT for table `pc_customer_search`
--
ALTER TABLE `pc_customer_search`
...
--
-- AUTO_INCREMENT for table `pc_event`
--
ALTER TABLE `pc_event`
...
--
-- AUTO_INCREMENT for table `pc_order_history`
--
ALTER TABLE `pc_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_order_option`
--
ALTER TABLE `pc_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_order_product`
--
ALTER TABLE `pc_order_product`
...
--
-- AUTO_INCREMENT for table `pc_order_total`
--
ALTER TABLE `pc_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_order_voucher`
--
ALTER TABLE `pc_order_voucher`
...
--
-- AUTO_INCREMENT for table `pc_product_option_value`
--
ALTER TABLE `pc_product_option_value`
...
--
-- AUTO_INCREMENT for table `pc_statistics`
--
ALTER TABLE `pc_statistics`
...
--
-- AUTO_INCREMENT for table `pc_subscription_history`
--
ALTER TABLE `pc_subscription_history`
...
--
-- AUTO_INCREMENT for table `pc_topic`
--
ALTER TABLE `pc_topic`
  MODIFY `topic_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_translation`
--
ALTER TABLE `pc_translation`
  MODIFY `translation_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_upload`
--
ALTER TABLE `pc_upload`
...
--
-- AUTO_INCREMENT for table `pc_user_authorize`
--
ALTER TABLE `pc_user_authorize`
  MODIFY `user_authorize_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pc_user_group`
--
ALTER TABLE `pc_user_group`
